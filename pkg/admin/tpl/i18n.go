...
var i18n = map[string]map[string]string{
	"en": {
		...
		"pages_tree_copy_page":                "Copy Page",
		...
		"pages_copy_page_window_title":        "Copy Page",
		"pages_copy_page_name":                "New Name",
		"pages_copy_page_submit":              "Save",
		"pages_copy_page_hint":                "Please remember to update the URLs and other parameters after copying the page!",
		...
		"content_page_element_reference_remove":       "Remove Reference",
		...
		"content_reference_remove_window_title":       "Remove Reference",
		"content_reference_remove_confirm":            "Are you sure that you would like to remove this reference? A copy of the reference will be added as a new element, so that it can be edited.",
		"content_reference_remove_submit":             "Remove",
		...
		"content_element_edit_reset_color":            "Reset Color",
	...
	"de": {
		...
		"pages_tree_copy_page":                "Seite kopieren",
		...
		"pages_copy_page_window_title":        "Seite kopieren",
		"pages_copy_page_name":                "Neuer Name",
		"pages_copy_page_submit":              "Speichern",
		"pages_copy_page_hint":                "Bitte denke daran die URLs und andere Parameter anzupassen, nachdem die Seite kopiert wurde!",
		...
		"content_page_element_reference_remove":       "Referenz entfernen",
		...
		"content_reference_remove_window_title":       "Referenz entfernen",
		"content_reference_remove_confirm":            "Bist du sicher, dass du die Referenz entfernen möchtest? Dadurch wird die Referenz kopiert und als neues Element eingefügt, so dass es bearbeitet werden kann.",
		"content_reference_remove_submit":             "Entfernen",
		...
		"content_element_edit_reset_color":            "Farbe zurücksetzen",
